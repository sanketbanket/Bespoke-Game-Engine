...
void main(){         //NOTE : AMBIENT COLOR IS BEING ADDED OVER AND OVER WITH EACH LIGHT HENCE THAT IS SOMETHING THAT NEEDS TO BE TAKEN CARE OF.

point.position = vec3(0.0f, 2.0f, 2.0f);
point.diffuse = vec3(1.0f,0.0f, 0.0f);
point.specular = vec3(1.0f,0.0f, 0.0f);
